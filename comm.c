...
//function definition for sendDATA(), this functionill calculate 16000
//sample for 8 pieces of faster decibel values and send them using curl 
//library fction to an URL. The format of POST data is 
